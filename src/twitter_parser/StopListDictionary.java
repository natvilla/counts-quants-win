...
public class StopListDictionary {
	...
	// return the constructed instance of the object.
	...
	// this function will get the singleton and do the query on the data structure,
	// eliminating the need to get the reference.
	...
	private StopListDictionary()
	{
		...
		// build the stop word prefix dictionary
		m_prefixDictionary = new LinkedList<String>();
		m_prefixDictionary.add("http");
		
		// build the primary stop word dictionary using a list obtained from http://norm.al/2009/04/14/list-of-english-stop-words/
